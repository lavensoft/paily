...
final mockup = [
  ...
  Store(
    id: '2',
    name: 'Dragon Bridge ',
    description: 'Dragon Bridge is the 6th bridge and the newest bridge across the Han River',
  ...
  Store(
    id: '4',
    name: 'Da Nang Sun World',
    description: 'Colorful festival multiplies the joy',
  ...
  Store(
    ...
    description: 'Premier Village Danang Resort - Managed by Accorhotels',
  ...
  Store(
    ...
    description: 'All Seasons Buffet',
